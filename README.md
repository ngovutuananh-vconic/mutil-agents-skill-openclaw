...
bash scripts/scaffold-workspaces.sh \
  ...
  ~/.openclaw/workspace-agents/agent-a \
  ~/.openclaw/workspace-agents/agent-b \
  ~/.openclaw/workspace-agents/agent-c
```
...
Suggested pattern:
- Primary agent: balanced/reliable model
- Specialist agents: domain-strong models for their assigned role
